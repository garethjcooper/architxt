...
export function EntityTypeIdSeparatorSelect({ id, value, onChange, disabled, compact }: Props) {
  return (
    <select
      ...
      disabled={disabled}
      className={`w-full rounded-md border border-white/10 bg-surface-card text-white/80 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30 outline-none ${
