...
export function EntityTypeIdSeparatorSelect({ id, value, onChange, disabled, compact }: Props) {
  return (
    <select
      ...
      disabled={disabled}
      className={`w-full rounded-md border border-white/10 bg-surface-card text-white/80 focus:border-accent-primary-bd focus:ring-2 focus:ring-focus-ring-subtle outline-none ${
