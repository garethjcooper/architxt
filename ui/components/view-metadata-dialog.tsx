        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="key" className="text-xs uppercase text-foreground-subtle font-medium">
                Key
              </Label>
              <Input
                id="key"
            ...
            {/* Value */}
            <div className="space-y-2">
              <Label htmlFor="value" className="text-xs uppercase text-foreground-subtle font-medium">
                Value
              </Label>
              <Input
                id="value"
          ...
          <div className="grid grid-cols-2 gap-4 pt-2 border-t border-border-default">
            <div className="space-y-1">
              ...
              <p className="text-sm text-foreground-default font-mono">{metadata.id}</p>
            </div>
            <div className="space-y-1">
              <p className="text-xs uppercase text-foreground-subtle font-medium">Generated By</p>
              <p className="text-sm text-foreground-default font-mono capitalize">{metadata.generated_by}</p>
            </div>
            <div className="space-y-1">
