          ...
          <tbody>
            {displayContexts.length === 0 && !loading ? (
              ...
              displayContexts.map((context) => (
                ...
                >
                  <td className={["py-1.5 px-4", freeze && "sticky left-0 z-10 border-r border-white/5", selected.has(context.id) ? "bg-violet-900/20" : "bg-surface-card"].filter(Boolean).join(" ")} onClick={(e) => e.stopPropagation()}>
                    <Checkbox
