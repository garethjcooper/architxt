          ...
          <table className="w-full caption-bottom text-sm">
            <thead>
              <tr className="border-b border-border-default">
                ...
                <th className={["text-xs uppercase text-foreground-faint font-medium py-2 px-4 text-left", !freeze && "sticky top-0 z-20 bg-surface-card"].filter(Boolean).join(" ")}>Role ID</th>
                <th className={["text-xs uppercase text-foreground-faint font-medium py-2 px-4 text-left", !freeze && "sticky top-0 z-20 bg-surface-card"].filter(Boolean).join(" ")}>Display Name</th>
                <th className={["text-xs uppercase text-foreground-faint font-medium py-2 px-4 text-left", !freeze && "sticky top-0 z-20 bg-surface-card"].filter(Boolean).join(" ")}>Scope</th>
                <th className={["text-xs uppercase text-foreground-faint font-medium py-2 px-4 text-left", !freeze && "sticky top-0 z-20 bg-surface-card"].filter(Boolean).join(" ")}>Sort</th>
                <th className={["text-xs uppercase text-foreground-faint font-medium py-2 px-4 text-left", !freeze && "sticky top-0 z-20 bg-surface-card"].filter(Boolean).join(" ")}>Type</th>
                <th className={["text-xs uppercase text-foreground-faint font-medium py-2 px-4 text-left", !freeze && "sticky top-0 z-20 bg-surface-card"].filter(Boolean).join(" ")}>Mental Models</th>
            ...
            <tbody>
              {displayRoles.length === 0 && !loading ? (
                <tr>
                  <td colSpan={8} className="text-center py-8 text-foreground-faint">
                ...
                displayRoles.map((role) => {
                  ...
                  return (
                    ...
                    >
                      <td
                        className={["py-1.5 px-4", freeze && "sticky left-0 z-10 border-r border-border-subtle", role.is_system ? "bg-accent-primary-bg/50" : isSelected ? "bg-accent-primary-bg" : "bg-surface-card"].filter(Boolean).join(" ")}
                      ...
                      <td className="py-1.5 px-4 text-xs text-foreground-subtle font-mono">{role.role_id}</td>
                      <td className="py-1.5 px-4 text-xs">
                        <span className="font-semibold text-foreground-default">{role.display_name}</span>
                      </td>
                      <td className="py-1.5 px-4 text-xs">
                      ...
                      <td className="py-1.5 px-4 text-xs text-foreground-faint">{role.sort_order}</td>
