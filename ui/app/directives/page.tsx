    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <Button
          ...
          className="inline-flex items-center gap-1.5 h-8 px-3 rounded text-sm font-medium bg-surface-card border border-orange-500/30 text-orange-300 hover:bg-surface-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <tbody>
            {displayDirectives.length === 0 && !loading ? (
              ...
              displayDirectives.map((directive) => (
                ...
                >
                  <td className={["py-1.5 px-4", freeze && "sticky left-0 z-10 border-r border-white/5", selected.has(directive.id) ? "bg-amber-900/20" : "bg-surface-card"].filter(Boolean).join(" ")} onClick={(e) => e.stopPropagation()}>
                    <Checkbox
