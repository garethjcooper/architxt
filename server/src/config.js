...
export const config = {
  ...
  research: {
    synthesize: {
      ...
      max_tokens: getEnv('ARCHITXT_RESEARCH_SYNTHESIZE_MAX_TOKENS', '') !== ''
        ...
        : undefined,
      system_prompt: getEnv('ARCHITXT_RESEARCH_SYNTHESIZE_SYSTEM_PROMPT', ''),
  ...
  document_denoise: {
    ...
    remove_page_numbers: getEnv('ARCHITXT_DENOISE_REMOVE_PAGE_NUMBERS', 'true') === 'true',
    remove_confidential_headers: getEnv('ARCHITXT_DENOISE_REMOVE_CONFIDENTIAL', 'true') === 'true',
    remove_document_ids: getEnv('ARCHITXT_DENOISE_REMOVE_DOC_IDS', 'true') === 'true',
    unescape_html_entities: getEnv('ARCHITXT_DENOISE_UNESCAPE_HTML', 'true') === 'true',
    unescape_markdown_punctuation: getEnv('ARCHITXT_DENOISE_UNESCAPE_MARKDOWN_PUNCT', 'true') === 'true',
