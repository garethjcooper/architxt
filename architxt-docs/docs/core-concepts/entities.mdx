...
Entities in architxt are the people, systems, components, concepts, or any other real-world items you want to recognize inside documents and connect to the contextual graph. They map closely to Hindsight's retain-time [`entities`](https://hindsight.vectorize.io/developer/api/retain#entities) and the entity labels stored in a [memory bank](https://hindsight.vectorize.io/developer/api/memory-banks#entity-labels).
