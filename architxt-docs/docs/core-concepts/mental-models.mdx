...
Mental models live in the `mental_models` table in SQLite. The route layer is `server/src/routes/mental-models.js` and the CRUD layer is `server/src/db/crud/mental-models.js`.
