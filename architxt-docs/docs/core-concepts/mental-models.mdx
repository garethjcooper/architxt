...
For background on how Hindsight uses mental models, see the [Hindsight mental models guide](https://hindsight.vectorize.io/developer/mental-models). For the API surface, see the [Hindsight mental models API](https://hindsight.vectorize.io/developer/api/mental-models).
...
| **Refresh Mode** | `refresh_mode` | `Full` rebuild or `Delta` incremental update. | [Refresh mode](https://hindsight.vectorize.io/developer/api/mental-models#refresh-mode) |
| **Tags Match** | `tags_match_mode` | How document tags must match the model's tags. | [Tags and visibility](https://hindsight.vectorize.io/developer/api/mental-models#tags-and-visibility) |
| **Refresh after consolidation** | `refresh_after_consolidation` | Run a refresh once memory consolidation completes. | [Automatic refresh](https://hindsight.vectorize.io/developer/api/mental-models#automatic-refresh) |
| **Exclude All Mental Models** | `exclude_all_mental_models` | Hide every other mental model from this one during refresh. | [Tags and visibility](https://hindsight.vectorize.io/developer/api/mental-models#tags-and-visibility) |
| **Exclude List** | `exclude_mental_model_list` | Comma-separated list of other mental model IDs to exclude. | [Tags and visibility](https://hindsight.vectorize.io/developer/api/mental-models#tags-and-visibility) |
| **Max Tokens** | `max_tokens` | Answer token budget. Allowed range: 1–8192. | [Structured output](https://hindsight.vectorize.io/developer/api/mental-models#structured-output) |
