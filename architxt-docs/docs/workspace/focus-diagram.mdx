...
Mermaid chooses the layout renderer from frontmatter in the diagram source. You can override the default renderer by adding a `config` block at the top of the source.
